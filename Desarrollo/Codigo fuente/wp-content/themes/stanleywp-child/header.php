...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-55450d0370d59c8d" async="async"></script>
<?php wp_head(); ?> 
...
<?php gents_container(); // before container hook ?>
    ...
    <header id="header_vamosya">
   
    <?php gents_in_header(); // header hook ?>

<div id="baseUrlPath" style="display: none;"> <?php echo get_bloginfo('wpurl').'/wp-content/themes/stanleywp-child/assets/images/' ?> </div>

<nav id="nav_vamosya" role="navigation">

    </div>

    <div class="navbar navbar-inverse navbar-static-top" id="navbar-static-vamosya" logofirst="<?=get_stylesheet_directory_uri();?>/assets/images/logo_vamosyafirstbig.png" logosecond="<?=get_stylesheet_directory_uri();?>/assets/images/logo_vamosyasecond.png">
        <div class="container">
           ...
           <?php if( bi_get_data('custom_logo') !== '' ) { ?>
              <div id="logo"><a href="<?php echo home_url(); ?>/" title="<?php bloginfo( 'name' ); ?>" rel="home">
                  <img id="logochange" src="<?php echo bi_get_data('custom_logo'); ?>" alt="<?php bloginfo( 'name' ) ?>" />
              </a></div>
            <?php } else { ?>
